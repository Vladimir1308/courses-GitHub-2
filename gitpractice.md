...
### git log --graph
Команда показывает сколько веток на истории коммитов,  используя команду *it log --graph*.Команда показывает сколько веток на истории коммитов,  используя команду *git log --graph*.
